public abstract class Jogador implements Comparable<Jogador>, JogadorBase {
    ...
    public Jogador(String cor, int numeroCasa, int pulaProximaRodada) {
        this.pulaProximaRodada = pulaProximaRodada;
        this.cor = cor;
        this.numeroCasa = numeroCasa;
        this.numeroDeJogadas = 0;
        this.pontuacaoEmMoedas = 0; // Corrigido para inicializar com 0
    ...
    public String getDescricao() {
        String descricao = "Jogador: cor=" + cor + ", número da casa=" + numeroCasa;
