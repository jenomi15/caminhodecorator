...
public class CasaSurpresa extends Casa {
    ...
    private void TrocaJogador(Jogador jogador, int tipoJogador) {
        ...
        int pulaProximaRodada = jogador.pulaRodada(); // Assume que é um booleano ou int
        ...
        // Aqui você deve garantir que está substituindo o jogador correto na lista de jogadores.
        // Você pode precisar passar uma referência à lista de jogadores ou ao tabuleiro onde o jogador está.
    }
