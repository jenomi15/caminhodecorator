...
public class CasaSurpresa extends Casa {
    ...
    private void TrocaJogador(Jogador jogador, int tipoJogador) {
        ...
        switch (tipoJogador) {
            case 1:
                novoJogador = new JogadorAzarado(jogador.getCor(),jogador.getNumeroCasa(),jogador.getPulaProximaRodada(), jogador.getNumeroDeJogadas(), jogador.getPontuacaoEmMoedas());
                break;
            case 2:
                novoJogador = new JogadorNormal(jogador.getCor(),jogador.getNumeroCasa(),jogador.getPulaProximaRodada(), jogador.getNumeroDeJogadas(), jogador.getPontuacaoEmMoedas());
                break;
            case 3:
                novoJogador = new JogadorSortudo(jogador.getCor(),jogador.getNumeroCasa(),jogador.getPulaProximaRodada(), jogador.getNumeroDeJogadas(), jogador.getPontuacaoEmMoedas());
                break;
            default:
