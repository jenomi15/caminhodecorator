...
public class JogadorAzarado extends Jogador {
    ...
    public JogadorAzarado(String cor, int numeroCasa , int pulaProximaRodada , int numeroDeJogadas , int pontuacaoEmMoedas ) {
      ...
      //  this.temBoné = temBoné;
      //  this.temMoleton = temMoleton;
        //this.temOculosEscuros = OculosEscuros;
    ...
    public String toString() {
        return "Jogador Azarado: cor = " + getCor() + ",  o numero da Casa = " + getNumeroCasa();
    }
